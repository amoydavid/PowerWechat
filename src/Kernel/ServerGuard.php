...
use PowerWeChat\Kernel\Contracts\MessageInterface;
use PowerWeChat\Kernel\Exceptions\BadRequestException;
use PowerWeChat\Kernel\Exceptions\InvalidArgumentException;
use PowerWeChat\Kernel\Messages\Message;
use PowerWeChat\Kernel\Messages\News;
use PowerWeChat\Kernel\Messages\NewsItem;
use PowerWeChat\Kernel\Messages\Raw as RawMessage;
use PowerWeChat\Kernel\Messages\Text;
use PowerWeChat\Kernel\Support\XML;
use PowerWeChat\Kernel\Traits\Observable;
use PowerWeChat\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \PowerWeChat\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\PowerWeChat\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \PowerWeChat\Kernel\Exceptions\InvalidArgumentException
     * @throws \PowerWeChat\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \PowerWeChat\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \PowerWeChat\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \PowerWeChat\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
