...
namespace PowerWeChat\MicroMerchant\Kernel;

use PowerWeChat\Kernel\Exceptions\InvalidArgumentException;
use PowerWeChat\Kernel\Support;
use PowerWeChat\MicroMerchant\Application;
use PowerWeChat\MicroMerchant\Kernel\Exceptions\EncryptException;
use PowerWeChat\Payment\Kernel\BaseClient as PaymentBaseClient;
...
class BaseClient extends PaymentBaseClient
{
     ...
     *
     * @param \PowerWeChat\MicroMerchant\Application $app
     */
     ...
     *
     * @throws \PowerWeChat\Kernel\Exceptions\InvalidArgumentException
     * @throws \PowerWeChat\MicroMerchant\Kernel\Exceptions\EncryptException
     */
