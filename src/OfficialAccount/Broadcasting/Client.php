...
namespace PowerWeChat\OfficialAccount\Broadcasting;
...
use PowerWeChat\Kernel\Messages\Image;
use PowerWeChat\Kernel\Messages\Media;
use PowerWeChat\Kernel\Messages\Text;
use PowerWeChat\Kernel\Support\Arr;

/**
 * Class Client.
 *
 * @method \Psr\Http\Message\ResponseInterface|\PowerWeChat\Kernel\Support\Collection|array|object|string
