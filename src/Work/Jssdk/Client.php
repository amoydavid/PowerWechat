...
class Client extends BaseClient
{
     ...
     * @param string $type
     *
     * @return array|\PowerWeChat\Kernel\Support\Collection|mixed|object|\Psr\Http\Message\ResponseInterface|string
     *
    ...
    {
        $cacheKey = sprintf('PowerWeChat.work.jssdk.ticket.%s.%s', $type, $this->getAppId());
