...
namespace PowerWeChat\OpenWork\Work;

use PowerWeChat\OpenWork\Application as OpenWork;
use PowerWeChat\OpenWork\Work\Auth\AccessToken;
use PowerWeChat\Work\Application as Work;
