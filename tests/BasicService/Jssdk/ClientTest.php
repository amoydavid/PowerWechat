...
namespace PowerWeChat\Tests\BasicService\Jssdk;

use PowerWeChat\BasicService\Jssdk\Client;
...
class ClientTest extends TestCase
{
    ...
    public function testGetTicket()
    {
        ...
        $response = new \PowerWeChat\Kernel\Http\Response(200, [], json_encode($ticket));
