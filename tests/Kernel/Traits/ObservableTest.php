...
use PowerWeChat\Kernel\Exceptions\Exception;
...
class ObservableTest extends TestCase
{
    ...
    public function testMakeClosureWithInvalidCases()
    {
        ...
        try {
            ...
            $this->assertSame('Class "stdClass" not an instance of "PowerWeChat\Kernel\Contracts\EventHandlerInterface".', $e->getMessage());
        }
